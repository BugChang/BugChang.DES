(function () {
        ...
        $("#btnSave").click(function () {
            ...
            if (count===0) {
                ...
                $.ajax({
                    ...
                    url: "/Letter/BackLetter/" + letterId,
    ...
    function initBackTable() {
        backTable = $('#backTable').DataTable({
            ordering: false,
            processing: true,
            serverSide: true,
            autoWith: true,
            ajax: {
                url: '/Letter/GetBackLetters'
            },
            stateSave: true,
            columns: [
                {
